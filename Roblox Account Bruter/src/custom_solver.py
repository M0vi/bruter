...
def get_token(roblox_session: requests.Session, blob, proxy, cookie):
    ...
    browserInfo = {
        ...
        'User-Agent': "Mozilla/5.0 (iPhone; CPU iPhone OS 17_6_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.6 Mobile/15E148 Safari/604.1", #roblox_session.headers["user-agent"],
        'Mobile': True
    }
